      ...
      <div class="top-items">
        <div class="option-item">
          <a href="createDish.php">
            <img src="Add Items Logo.png" alt="Add Image">
          </a>
          <div class="option-text">Add Menu Items</div>
        </div>
        <div class="option-item">
          <a href="getDishes.php">
            <img src="Update Items Logo.png" alt="Update Image">
          </a>
      ...
      <div class="bottom-items">
        <div class="option-item">
          <a href="modifyDish.php">
            <img src="Modify Items Logo.png" alt="Modify Image">
          </a>
          <div class="option-text">Modify Menu Items</div>
        </div>
        <div class="option-item">
          <a href="deleteDish.php">
            <img src="Delete Items Logo.png" alt="Delete Image">
          </a>
...
<a href="startScreen.php" class="logout-button">Logout</a>
</div>
</body>
</html>
