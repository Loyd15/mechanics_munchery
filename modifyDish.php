...
<div class="container">
  <h2>Modify Dish</h2>
  <form method="post" action="modifyDishProcess.php">
    Choose Table:
    ...
    <br><br>
    New Item Name: <input type="text" name="newItemName"><br><br>
    New Item Price: <input type="text" name="newItemPrice"><br><br>
